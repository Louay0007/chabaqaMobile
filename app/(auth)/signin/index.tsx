...
export default function SignInScreen() {
  ...
  // SUPPRIMÉ: La redirection automatique cause une boucle
  // La redirection se fait seulement après un login réussi via handleSuccessfulLogin
  ...
  const handleSelectTestCredentials = (
    testEmail: string,
    testPassword: string,
  ) => {
    setEmail(testEmail);
    ...
    setError("");
    setSuccessMessage(
      "✅ Identifiants de test chargés - Cliquez sur Se connecter",
    );
  };
  // ===== FIN MODE TEST STATIQUE =====
  ...
  return (
    ...
    >
      ...
      <AdaptiveBackground style={styles.background} resizeMode="cover">
        ...
        >
          <Header showTwoFactor={false} email={email} styles={styles} />
          ...
          <View style={styles.footer}>
            <Text style={styles.footerText}>
              © 2024 Chabaqa. Build the future of communities.
            </Text>
          </View>
        </ScrollView>
      </AdaptiveBackground>
