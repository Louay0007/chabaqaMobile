    ...
    switch (filter) {
      ...
      case "read":
        return {
          ...
          description:
            "Your read notifications will appear here once you start interacting with notifications.",
          suggestion: {
            label: "View All Notifications",
            onPress: () => onChangeFilter("all"),
            icon: Bell,
      ...
      default:
        return {
          ...
          description:
            "Stay tuned! You'll receive notifications about messages, course updates, events, and more.",
          suggestion: {
            label: "Explore Communities",
            onPress: () => {
              console.log("Navigate to communities");
              routerInstance.push("/(communities)");
            },
            icon: Users,
            colors: [colors.primary, "#9c88ff"] as [string, string],
          },
          secondaryAction: undefined,
          // Temporarily hidden - Start Messaging button
          // secondaryAction: {
          //   label: 'Start Messaging',
          //   onPress: () => {
          //     console.log('Navigate to messages');
          //     routerInstance.push('/(messages)');
          //   },
          //   icon: MessageSquare,
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.actions}>
          ...
          {/* Secondary Action - Temporarily hidden */}
      ...
      <View style={styles.decorativeElements}>
        ...
        <MessageSquare
          size={20}
          color="rgba(142, 120, 251, 0.08)"
          style={styles.deco2}
        />
        <Users
          size={14}
          color="rgba(142, 120, 251, 0.06)"
          style={styles.deco3}
        />
      </View>
    </View>
